...
public class EmployeeController {
	...
	/*
	 * consumes tells that this particular appl.. excepts json object
	 * @PostMapping because we are adding one employee.....
	 */	
	
	public EmployeeResponse addEmployee(@RequestBody EmployeeBean bean) {/* @ResponseBody */

		/*
		 * @ResponseBody shows it is a direct response not a logical view response.
		 * 
		 * @Controller + @ResonseBody = @RestController..........
		 */
	...
	public EmployeeResponse getEmployee(@RequestParam("id") int id) {
		...
		// @RequestParam used to except query string.....
	...
	public EmployeeResponse getAllEmployee(EmployeeBean bean) {
		EmployeeResponse response = new EmployeeResponse();

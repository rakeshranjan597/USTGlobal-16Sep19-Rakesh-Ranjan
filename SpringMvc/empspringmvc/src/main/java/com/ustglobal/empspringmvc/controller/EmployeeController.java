...
public class EmployeeController {
	...
	public String changepassword(String password, String confirmpassword,
		...
		if(password.equals(confirmpassword)) {
			service.changePassword(bean.getId(), confirmpassword);
...
//	String updatename, String updatepassword, String updateemail, String updatedoj
	@PostMapping("/updateprofile")
	public String updateprofile(String updatename, String updatepassword, String updateemail, String updatedoj, 
			@SessionAttribute(name = "bean")EmployeeBean bean, ModelMap map) {
		bean.setName(updatename);
		bean.setPassword(updatepassword);
		bean.setEmail(updateemail);
		bean.setDoj(updatedoj);
		try {
			service.updateEmployee(bean);
			map.addAttribute("msg", "Profile Updated");
		} catch(Exception e) {
			e.printStackTrace();
			map.addAttribute("msg", "Failed To Profile Updated");
		}
		return "home";
	}

...
//@Component
//instead to component make it repository bcz this is dao layer
@Repository
public class EmployeeDaoImpl implements EmployeeDAO{
	...
	public boolean updateEmployee(EmployeeBean bean) {
		...
		EntityTransaction transaction = manager.getTransaction();
		transaction.begin();
		EmployeeBean updateBean = manager.find(EmployeeBean.class, bean.getId());
